document.addEventListener('DOMContentLoaded', function() {
    ...
    var results = [
        ...
        // ...
        { name: 'Nguyễn Đăng Minh', totalAttempts: 59, completionRate: 95, averageScore: 9.2, scoreDistribution: [7, 8, 9, 10] },
        { name: 'Nguyễn Bá Dương', totalAttempts: 48, completionRate: 89, averageScore: 9.5, scoreDistribution: [7, 8, 9, 10] },
        { name: 'Lê Vũ Hoàng', totalAttempts: 37, completionRate: 92, averageScore: 3.8, scoreDistribution: [7, 8, 9, 10] },
        { name: 'Nguyễn Anh Đức', totalAttempts: 45, completionRate: 90, averageScore: 5.6, scoreDistribution: [7, 8, 9, 10] },
        { name: 'Trần Anh Đức', totalAttempts: 36, completionRate: 100, averageScore: 9.6, scoreDistribution: [7, 8, 9, 10] }
    ];
